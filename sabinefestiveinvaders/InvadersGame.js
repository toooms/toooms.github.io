...
var playerShip, 
	...
	screenWidth, 
	screenHeight, 
	playerType = Math.floor(0); // this is the browser that is playing
...
function updateInvaders() { 
	...
	speed = map(invaders.length, 50,0,0.001,0.05);
...
function renderMessage2(msg) { 
	ctx.textAlign = 'center';
	ctx.font = '35pt Courier, Arial';
	ctx.fillStyle = hsl(0, 0, (100-(counter*2)%100));
	ctx.fillText(msg, screenWidth/2, screenHeight/3); 
